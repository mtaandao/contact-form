...
class MNCF7_ContactFormTemplate {
	...
	public static function get_default( $prop = 'form' ) {
		...
		return apply_filters( 'mncf7_default_template', $template, $prop );
	}
...
function mncf7_messages() {
	...
	return apply_filters( 'mncf7_messages', $messages );
}
