...
function mncf7_editor_panel_form( $post ) {
?>
...
<textarea id="mncf7-form" name="mncf7-form" cols="100" rows="24" class="large-text code" data-config-field="form.body"><?php echo esc_textarea( $post->prop( 'form' ) ); ?></textarea>
<?php
}

function mncf7_editor_panel_mail( $post ) {
	mncf7_editor_box_mail( $post );

	echo '<br class="clear" />';

	mncf7_editor_box_mail( $post, array(
		'id' => 'mncf7-mail-2',
		'name' => 'mail_2',
...
function mncf7_editor_box_mail( $post, $args = '' ) {
	...
	$mail = mn_parse_args( $post->prop( $args['name'] ), array(
...
function mncf7_editor_panel_messages( $post ) {
	$messages = mncf7_messages();
...
function mncf7_editor_panel_additional_settings( $post ) {
	$desc_link = mncf7_link(
...
<textarea id="mncf7-additional-settings" name="mncf7-additional-settings" cols="100" rows="8" class="large-text" data-config-field="additional_settings.body"><?php echo esc_textarea( $post->prop( 'additional_settings' ) ); ?></textarea>
</fieldset>
<?php
}
