...
class MNCF7_Help_Tabs {

	private $screen;

	public function __construct( MN_Screen $screen ) {
		$this->screen = $screen;
	}
	...
	public function sidebar() {
		...
		$content .= '<p>' . mncf7_link( __( 'http://contactform7.com/docs/', 'contact-form-7' ), __( 'Docs', 'contact-form-7' ) ) . '</p>';
		$content .= '<p>' . mncf7_link( __( 'http://contactform7.com/faq/', 'contact-form-7' ), __( 'FAQ', 'contact-form-7' ) ) . '</p>';
		$content .= '<p>' . mncf7_link( __( 'http://contactform7.com/support/', 'contact-form-7' ), __( 'Support', 'contact-form-7' ) ) . '</p>';
